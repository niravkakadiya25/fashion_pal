                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                      child: Text(
                                          "Need some helps?",
                                          style: TextStyle(fontSize: 22,color: black_theme,fontWeight: FontWeight.bold)
                                      ),
                                      onTap: (){
                                              ...
                                              padding: const EdgeInsets.all(5.0),
                                               child: InkWell(
                                                  child : ClipRRect(
                                                    ...
                                                    child: Image.asset("images/ic_contactus.png",
                                                      fit: BoxFit.fill,
                                                      color: Colors.black,
                                                      height: 25.0,
                                                      width: 25.0,),
                                                    ...
                                                    child:Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            child: Text(
                                                              "Clarmount Lodge, 19A Residential",
                                                              textAlign: TextAlign.center,
                                                              style: TextStyle(
